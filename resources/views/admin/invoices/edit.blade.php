...
<section class="content">
	<div class="container-fluid">
		<div class="card card-info">
		  ...
		  <form role="form" method="post" action="{{ route('invoice.update', ['invoice'=>$invoice->id]) }}">
		  	{{ csrf_field() }}
		  	{{ method_field('PUT') }}
		    <div class="card-body">
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="txtInvoiceNo" name="txtInvoiceNo" placeholder="Invoice No." value="{{ $invoice->invoice_no }}">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control float-right datepicker" id="txtInvoiceDate" name="txtInvoiceDate" value="{{ $invoice->invoice_date }}">
							</div>
						</div>
					</div>	
				</div>	
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="txtCustomerName" name="txtCustomerName" placeholder="Customer Name" value="{{ $invoice->customer_name }}">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label for="MobileNo">Mobile No.</label>
							<input type="text" class="form-control" id="txtMobileNo" name="txtMobileNo" placeholder="Mobile Number" value="{{ $invoice->mobile_no }}">
						</div>
					</div>
				</div>	
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<textarea class="form-control" id="txtAddress" name="txtAddress" placeholder="Address">{{ $invoice->address }}</textarea>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label for="City">City</label>
							<input type="text" class="form-control" id="txtCity" name="txtCity" placeholder="City" value="{{ $invoice->city }}">
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							...
							<textarea class="form-control" id="txtRemarks" name="txtRemarks" placeholder="Remarks">{{ $invoice->remarks }}</textarea>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
					        ...
					        <option value="Paytm" {{ $invoice->payment_mode == 'Paytm' ? 'selected' : '' }}>Paytm</option>
					        <option value="Credit" {{ $invoice->payment_mode == 'Credit' ? 'selected' : '' }}>Credit</option>
					        <option value="Finance" {{ $invoice->payment_mode == 'Finance' ? 'selected' : '' }}>Finance</option>
							</select>
						</div>
					</div>
				</div>	
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
				        	...
				        	<input type="checkbox" class="form-check-input" id="chkPaid" name="chkPaid" value="1" {{  $invoice->is_paid == '1' ? 'checked' : '' }}>
		                  	...
		                  	@foreach($invoice_details as $invoice_detail)
								...
								<tr>
									...
									<td class="td_product_code">
			                      	...
			                      	{{ $invoice_detail->product_id == $product->id ? 'selected' : '' }}>{{ $product->product_code}}</option>
			                      	@endforeach
			                      	</select>
			                      	<input type="hidden" class="form-control txt_product_code" name="txtProductCode[]" size="5" value="{{ $invoice_detail->product_code }}">
		                      		<input type="hidden" class="form-control txt_product_desc" name="txtProductDescription[]" size="5" value="{{ $invoice_detail->product_description }}">		
			                    	</td>
			                    	<td class="td_description">{{ $invoice_detail->product_description }}</td>
			                    	<td class="td_quantity"><input type="number" min="0" step="1" class="form-control txt_quantity" name="txtQty[]" placeholder="Qty" value="{{ $invoice_detail->quantity }}" onchange="calculate_amount(this);"></td>
			                    	<td class="td_price"><input type="number" min="0" step="1" class="form-control txt_price" name="txtPrice[]" placeholder="Price" value="{{ $invoice_detail->price }}" onchange="calculate_amount(this);"></td>
			                    	<td class="td_discountamt"><input type="number" min="0" step="1" class="form-control txt_discountamt" name="txtDiscount[]" placeholder="Discount" value="{{ $invoice_detail->discount }}" onchange="calculate_amount(this);"></td>
			                    	<td class="td_amount"><input type="number" class="form-control txt_amount" name="txtAmount[]" placeholder="Amount" value="{{ $invoice_detail->amount }}" onchange="calculate_total_amount();" readonly></td>
			                    	<td class="row_remove">
		                  ...
		                  <thead>                  
							<tr>
								...
								<th style="font-weight:bold;" colspan="2">
									...
									name="txtTotalAmount" placeholder="Total Amount" value="{{ $invoice->total_amount }}" readonly>
								</th>
							</tr>
		                  </thead>
		                </table>
